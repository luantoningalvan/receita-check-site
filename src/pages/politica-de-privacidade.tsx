...
export default function PrivacyPolicy() {
  return (
    <div className={styles.privacyPolicy}>
      <Head>
        <title>Política de Privacidade - Receita Check</title>
        <meta
          name="description"
          content="Entenda como o Receita Check utiliza os seus dados"
        />
      </Head>
      ...
      <main>
        ...
        <p>
          A sua privacidade é importante para nós. É política do ReceitaCheck
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site{" "}
          <a href="https://receitacheck.com.br">ReceitaCheck</a>, e outros sites
        ...
        <h2>Política de Cookies ReceitaCheck</h2> <h3>O que são cookies?</h3>
        <p>
        ...
        <p>
          ...
          informação que o ReceitaCheck oferece no site e com caráter
        ...
        <ul>
          ...
          <li>
            ...
            (softwares) do ReceitaCheck, de seus fornecedores ou terceiros, para
        ...
        <p>
          Esta política é efetiva a partir de <strong>24 setembro 2022</strong>
        </p>
      </main>
    </div>
  );
